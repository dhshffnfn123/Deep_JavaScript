...
//? 객체 밀봉
// Object.seal 메서드는 객체를 말한다. 객체 밀봉이란 프로퍼티 추가 및 삭제와 프로퍼티 어트리뷰트 재정의 금지를 말한다.
// TODO 밀봉된 객체는 읽기와 쓰기만 가능하다.
...
// {  "name": { "value": "An", "writable": true, "enumerable": true, "configurable": false  } }
...
// person 객체를 동결하여 프로퍼티의 추가, 삭제, 재정의, 쓰기를 금지한다.
...
console.log(Object.getOwnPropertyDescriptors(person));
// {  "name": { "value": "An", "writable": false, "enumerable": true, "configurable": false  } }
...
person.address.city = 'Paju';
console.log(person); // {name: 'An', address: { city: 'Paju' }}
